 ...
 * @author Shai Almog
 */
public class MyOnTrackAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "MyOnTrackApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new MyOnTrackAppStub());
    }
