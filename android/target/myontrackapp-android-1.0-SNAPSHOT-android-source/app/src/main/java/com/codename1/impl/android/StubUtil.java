 ...
 * And  "be.ontrack.MyOnTrackAppStub" (without quotes) with the fully qualified class name of the app stub.
 * @author shannah
 */
public class StubUtil {
    ...
    static boolean appIsRunning() {
        if (true) {
            return be.ontrack.MyOnTrackAppStub.isRunning();
        }
        if (true) {
    ...
    static Class getAppStubClass() {
        if (true) {
            return be.ontrack.MyOnTrackAppStub.class;
        }
        if (true) {
    ...
    static Object getMain() {
        if (true) {
            return be.ontrack.MyOnTrackAppStub.getAppInstance();
        }
        if (true) {
