...
public class MyOnTrackAppStub extends CodenameOneActivity{
    ...
    public static MyOnTrackAppStub getInstance() {
        return stubInstance;
    }

    public MyOnTrackAppStub() {
        stubInstance = this;
    }
...
AndroidImplementation.startContext(this);
        ...
        Display.getInstance().callSerially(new Runnable(){
            ...
            public void run() {
                ...
                MyOnTrackAppStub.this.run(displayForm == null ? currForm : displayForm, wasStopped);
            }
        });
        synchronized(LOCK) {
            currentForm = null;
